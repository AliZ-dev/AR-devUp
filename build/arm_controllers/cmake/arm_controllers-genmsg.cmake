...
set(MSG_I_FLAGS "-Iarm_controllers:/home/tarek/repos/ar-devup/src/arm_controllers/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tarek/repos/ar-devup/src/arm_controllers/msg/ControllerJointState.msg" NAME_WE)
add_custom_target(_arm_controllers_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arm_controllers" "/home/tarek/repos/ar-devup/src/arm_controllers/msg/ControllerJointState.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(arm_controllers
  "/home/tarek/repos/ar-devup/src/arm_controllers/msg/ControllerJointState.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arm_controllers)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arm_controllers\")")
  # install generated code
  install(
